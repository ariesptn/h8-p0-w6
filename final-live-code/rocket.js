...
function formatDuration(seconds) {
  if (seconds === 0) {
    ...
    if (Math.floor(detik) > 0) {
      return Math.floor(seconds / 60) + ' menit dan ' + detik + ' detik'
    } else {
      return Math.floor(seconds / 60) + ' menit '
    }
  } else if (seconds < 86400) {
    return Math.floor(seconds / 3600) + ' jam, ' + formatDuration(seconds % 3600)
  } else if (seconds < 31390000) {
    return Math.floor(seconds / 86400) + ' hari, ' + formatDuration(seconds % 86400)
    // } else if (seconds < 31557600) {
    //   return Math.floor(seconds / 2630000) + ' bulan ' + formatDuration(seconds % 2630000)
  } else {
    return Math.floor(seconds / 31390000) + ' tahun, ' + formatDuration(seconds % 31390000)
  }
}
